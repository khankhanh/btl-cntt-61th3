...
<head>
    ...
    <link rel="stylesheet" href="./public/site/css/register.css">
                ...
                <div class="page_lightbox ">
                    ...
                    <div class="box-right-login">
                        <div class="box-user-have-acc">
                            ...
                            <div class="box-show-btn"><a href="signin.php" title="Đăng ký ngay" class="btn-action-login-register">Đăng nhập ngay</a></div>
