...
?>
    ...
    <div class="main">
            ...
            <div class="box-left">
                <div class="box_cata_control">
                    <ul class="detail_menu_browsing_dashboard">
                        ...
                        <li><a class="" href="#no" rel="dofollow" title="Rap Việt">Rap Việt</a></li>
                        ...
                        <li>
                            <a pr="list_khac" href="nhacphim.html" rel="dofollow" title="Nhạc Phim">Beat</a>
                        </li>
                        <li class="view_more_list">
                            <a id="listchild_aumy">... Xem thêm</a>
                            <ul class="dot_more ">
                                <li>
                                    <a pr="listchild_aumy" href="#no" rel="dofollow" title="Thể Loại Khác">Thể Loại Khác</a>
                                </li>
                                <li>
                                    <a pr="listchild_aumy" href="#no" rel="dofollow" title="Tui Hát">Tui Hát</a>
                                </li>
                            </ul>
                ...
                <div class="album__container">
                    <div class="title_box_key_left">
                        <h1><a title="" href="#no" class="nomore">BÀI HÁT HOT NHẤT</a></h1>
                    </div>
            ...
            <div class="box-right">
                <div class="box_chart_music">
                    <div class="title_box_key">
                        <h3><a class="nomore" href="#no" title="BXH Bài hát">BXH Bài hát</a></h3>
                        <a href="#no" title="BXH Bài hát" class="play_all"></a>
                    </div>
                    <div class="btn_tab_select">
                        <a id="top20_bai-hat_nhac-viet" href="#no" class="active" title="Việt Nam">Việt Nam</a>
                        <span></span>
                        <a id="top20_bai-hat_au-my" href="#no" title="Âu Mỹ">Âu Mỹ</a>
                        <span></span>
                        <a id="top20_bai-hat_nhac-han" href="#no" title="Hàn Quốc">Hàn Quốc</a>
                    </div>
                            ...
                            <li class="list-singer-content">
                                <a href="#no">
                                    <div class="list-singer-image  marhmello">
                                        <img src="./public/site/img/nghesi/marshmello.jpg" style="width:310px" alt="">
                            ...
                            <li class="list-singer-content">
                                <a href="#no">
                                    <div class="list-singer-image toctien">
                                        <img src="./public/site/img/nghesi/toctien.jpg" style="width:150px" alt="">
                                        <div class="overlay-hover-1">
                            ...
                            <li class="list-singer-content">
                                <a href="#no">
                                    <div class="list-singer-image vietathen">
                                        <img src="./public/site/img/nghesi/vietathen.jpg" style="width:150px" alt="">
                                        <div class="overlay-hover-1">
                            ...
                            <li class="list-singer-content">
                                <a href="#no">
                                    <div class="list-singer-image martingarrix">
                                        <img src="./public/site/img/nghesi/martingarrix.jpg" style="width:150px" alt="">
                                        <div class="overlay-hover-1">
                            ...
                            <li class="list-singer-content">
                                <a href="#no">
                                    <div class="list-singer-image ikon">
                                        <img src="./public/site/img/nghesi/ikon.jpg" style="width:150px" alt="">
                                        <div class="overlay-hover-1">
        ...
        <div class="box_pageview">
            ...
            <a href="#no" class="number " rel="next" title="">7</a>
            <a href="#no" class="number " rel="next" title="">8</a>
            <a href="#no" class="number " rel="next" title="">9</a>
            <a href="#no" class="number " rel="next" title="">10</a>
